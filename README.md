...
### Logo real, título "Empresa" y catálogo de productos
...
- **Catálogo de productos (nueva sección "Catálogo" en el menú):** antes los productos sólo se podían cargar por la base de datos; ahora hay una pantalla propia para ver, crear, editar y desactivar/reactivar productos del catálogo que se usa en Cotizaciones y Ventas, cargados a mano con "+ Nuevo producto".
